...
yargs_1.default(process.argv.slice(2)).command("$0 <name>", "Generate a migration from your current instance state", function (yargs) {
    return yargs
        .option("envFile", {
        type: "string",
        ...
        .option("preview", {
        type: "boolean",
        describe: "Execute the diff, but don't write to the file-system. !!Exception: if this is the first run of the script, the state file will be created!!",
        default: false,
    });
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                connect_1.initDb(argv.envFile);
                return [4 /*yield*/, migrate_1.default(argv)];
            case 1:
                _a.sent();
                process.exit(0);
                return [2 /*return*/];
