export declare type DirectusCollection = {
    collection: string;
    icon: string;
    note?: string | null;
...
export declare type DirectusField = {
    collection: string;
    field: string;
    special?: string | null;
...
export declare type DirectusPermission = {
    role: string | null;
    collection: string;
    action: string;
    permissions: string;
...
export declare type DirectusPreset = {
...
export declare type DirectusRelation = {
